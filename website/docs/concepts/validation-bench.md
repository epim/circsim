...
A validator you can't trust is worse than no validator, because it converts "I don't know" into false confidence. circsim would rather show you a gap than paper over it. Read [what circsim can and can't tell you](./fidelity) — it's not a disclaimer, it's the design philosophy.
